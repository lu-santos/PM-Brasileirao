...
public class PerformanceDAO implements BaseCrudDAO<Performance>{
    ...
    public void incluir(Performance t) throws Exception {
        ...
        pst.setInt(5, t.getPontosGanhos());
        pst.setInt(6, t.getVitorias());
        pst.setInt(7, t.getDerrotas());
        pst.setInt(8, t.getEmpates());
        pst.setInt(9, t.getJogos());
        pst.setInt(10, t.getGolsPro());
        pst.setInt(11, t.getGolsContra());
        pst.setString(12, t.getIndicador());
        pst.setDouble(13, t.getSaldo());
        pst.setDouble(14, t.getAproveitamento());
        pst.setBoolean(15, t.isMandante());
        pst.setBoolean(16, t.isVisitante());
        pst.executeUpdate();
